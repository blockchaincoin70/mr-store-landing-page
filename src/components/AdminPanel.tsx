...
import { LogOut, Settings, Package, MessageSquare, BarChart3, Menu, ShoppingCart, Warehouse, Receipt, Inbox } from 'lucide-react';
...
const AdminPanel = ({ user, onLogout }: AdminPanelProps) => {
  ...
  const NavigationTabs = () => (
    <TabsList className="grid w-full grid-cols-4 md:grid-cols-7 h-auto gap-1">
      ...
      <TabsTrigger value="messages" className="flex flex-col items-center space-y-1 p-2 md:p-3 text-xs">
